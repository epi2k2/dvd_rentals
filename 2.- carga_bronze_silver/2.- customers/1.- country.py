...
date_data = datetime.strptime('2024-05-13', '%Y-%m-%d')
...
hub_country = spark.read.table('silver.' + folder + '.hub_country')

# COMMAND ----------

# MAGIC %md
# MAGIC ### Selección de registros que no están en la tabla de destino e inserto en tabla hub_country

# COMMAND ----------

df_file = df
hub_table = hub_country
pk = 'country_key'
columns = ['country_key', 'country', 'rec_src', 'load_date']
hub_table_name = 'hub_country'
...
# MAGIC %sql
# MAGIC select * from silver.customers.hub_country
