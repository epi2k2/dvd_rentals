...
link_inventory = spark.read.table('silver.' + folder + '.link_inventory')
sat_inventory = spark.read.table('silver.' + folder + '.sat_inventory')

# COMMAND ----------

# MAGIC %md
# MAGIC ### Selección de registros que no están tabla link_inventory
...
pk = 'inventory_key'
columns = ['inventory_key', 'inventory_id', 'film_key', 'rec_src', 'load_date']
link_table_name = 'link_inventory'
...
# MAGIC %md
# MAGIC ### Selección de registros que no están en la tabla sat_inventory

# COMMAND ----------

df_file = df
sat_table = sat_inventory
pk = 'inventory_key'
columns = ['inventory_key', 'store_key', 'hash_diff', 'rec_src', 'start_date']
sat_table_name = 'sat_inventory'
